        ...
        <div className="Noticia" style={{opacity: noticia.vista? '0.5': '1'}}>
            <div className="media alert alert-primary my-4">
                ...
                <div className="media-body ml-4">
                    ...
                    <button className="btn btn-warning float-right" onClick={ () => marcarLeida(noticia._id)}><i className="fab fa-readme"> Leida</i></button>
                        
                    <button className="btn btn-danger float-left" onClick={ () => borrar(noticia._id)}><i className="far fa-trash-alt"> Borrar</i></button>
