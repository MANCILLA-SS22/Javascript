...
function ShareMealPage(){
    ...
    const [state, formAction] = useFormState(shareMeal, { message: null }); //(1)
    return <>
        ...
        <main className={classes.main}>
            <form className={classes.form} action={formAction}> {/* (2) */}
...
//(2)
//This kind of actions (action={shareMeal}) ARE SUPPORTED by NextJS and React here that will ensure that when this form is submitted, Next.js will, behind the scenes, create a request and send it to this Next.js 
