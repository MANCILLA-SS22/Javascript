...
async function actionNewEvent({ request, params }) { //(1)
    ...
    const token = getAuthToken();console.log(token);
...
//(1)
//We are using a Form element on our <NewEventPage /> component, so it "submits" the action to the current route path (which React router forwards to our defined action function).
