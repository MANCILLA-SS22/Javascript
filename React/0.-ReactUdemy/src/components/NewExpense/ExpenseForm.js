...
function ExpenseForm(props){
    ...
    const res = { enteredTitle: "", enteredAmount: "", enteredDate: "" }
    ...
    function inputChangeHandler(identifier, event){
        if (identifier === "title") setEnteredTitle(event.target.value);
        if (identifier === "date") setEnteredDate(event.target.value);
        if (identifier === "amount")setEnteredAmount(event.target.value);
    }
    ...
    return(
        <form onSubmit={submitHandler}>
            <div className="new-expense__controls">
                <div className="new-expense__control">
                    <label>Title</label>
                    <input type="text" name="enteredTitle" value={enteredTitle} onChange={event => inputChangeHandler("title", event)}/>
                </div>
                <div className="new-expense__control">
                    <label>Amount</label>
                    <input type="number" min="0.01" step="0.01" name="enteredAmount" value={enteredAmount} onChange={event => inputChangeHandler("amount", event)}/>
                </div>
                <div className="new-expense__control">
                    <label>Date</label>
                    <input type="date" min="2019-01-01" step="2025-12-31" name="enteredDate" value={enteredDate} onChange={event => inputChangeHandler("date", event)}/>
                </div>
            </div>
    ...
    return(
        <form onSubmit={submitHandler}>
            <div className="new-expense__controls">
                <div className="new-expense__control">
                    <label>Title</label>
                    <input type="text" name="enteredTitle" value={userInput.enteredTitle} onChange={(event) => titleChangeHandler(event)}/>
                </div>
                <div className="new-expense__control">
                    <label>Amount</label>
                    <input type="number" min="0.01" step="0.01" name="enteredAmount" value={userInput.enteredAmount} onChange={(event) => amountChangeHandler(event)}/>
                </div>
                <div className="new-expense__control">
                    <label>Date</label>
                    <input type="date" min="2019-01-01" step="2023-12-31" name="enteredDate" value={userInput.enteredDate} onChange={(event) => dateChangeHandler(event)}/>
                </div>
            </div>
    ...
    return (
        <form onSubmit={submitHandler}>
            <div className="new-expense__controls">
                <div className="new-expense__control">
                    <label>Title</label>
                    <input type="text" name="enteredTitle" value={userInput.enteredTitle} onChange={(event) => inputChangeHandler(event)} />
                </div>
                <div className="new-expense__control">
                    <label>Amount</label>
                    <input type="number" min="0.01" step="0.01" name="enteredAmount" value={userInput.enteredAmount} onChange={(event) => inputChangeHandler(event)} />
                </div>
                <div className="new-expense__control">
                    <label>Date</label>
                    <input type="date" min="2019-01-01" step="2023-12-31" name="enteredDate" value={userInput.enteredDate} onChange={(event) => inputChangeHandler(event)} />
                </div>
            </div>
