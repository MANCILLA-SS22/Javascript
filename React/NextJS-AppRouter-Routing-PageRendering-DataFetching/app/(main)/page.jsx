...
function HomePage() {
  return (
    <div id="home">
      ...
      <p>NextNews aims to provide you with the latest news in a concise and unbiased manner. We strive to deliver the news in a way that is easy to understand and to the point. We want to keep you informed without overwhelming you with unnecessary information. </p>
      ...
      <p><Link href="/news">Read the latest news</Link></p>
    </div>
  );
}
